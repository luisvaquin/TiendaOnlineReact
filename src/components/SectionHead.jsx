...
function SectionHead() {
    return (
        <section className="pb-12 bg-gradient-to-b from-[#E8E3F5] via-[#EDEAFB] to-[#F7FAFC] mb-[4.4rem]">
                ...
                <div className="justify-center w-full text-center lg:p-10 max-auto">
                    <div className="justify-center w-full mx-auto">
                        ...
                        <p className="mt-4 sm:px-32 text-[#10172A] sm:text-xl text-sm font-semibold tracking-tighter">
                            by @luisrodrigo2330@gmail.com
                        </p>
                        <p className="sm:mt-8 mt-3 sm:px-44 text-[#10172A] text-4xl sm:text-6xl font-semibold tracking-tighter">
                            Failed <span className="underline leading-8 underline-offset-8 decoration-8 decoration-[#7296f8]">Products</span> Of Top Brands.
                        </p>
